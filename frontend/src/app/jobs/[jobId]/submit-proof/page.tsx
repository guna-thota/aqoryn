...
export default function SubmitProofPage() {
  ...
  if (done) return (
    <div className="max-w-xl mx-auto text-center space-y-6 pt-16">
      ...
      <p className="text-gray-400">Client has 48 hours to review. Silence = auto-release to your wallet.</p>
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      {DELIVERABLES.map(d => (
        <div key={d.id} className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3">
          ...
          <input className="w-full bg-black/30 border border-white/10 rounded-xl px-4 py-3 text-sm placeholder-gray-600 focus:border-teal-500 outline-none"
